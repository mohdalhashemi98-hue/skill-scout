export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 bg-surface/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="#"
                className="h-9 w-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-muted/40 hover:text-white hover:border-primary/40 hover:bg-primary/10 transition-all duration-200"
                aria-label="Twitter"
              >
